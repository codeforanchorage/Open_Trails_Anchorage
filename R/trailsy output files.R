    ...
    dat[dat$TRAIL_NAME == "Tikisla Park Trail",]$TRAIL_NAME <- "Chester Creek Trail"
    ...
    dat[dat$TRAIL_NAME == "North Gasline",]$TRAIL_NAME <- "Gasline"
    dat[dat$TRAIL_NAME == "North Fork",]$TRAIL_NAME <- "Long Lake"
    dat[dat$TRAIL_NAME == "Alder 1",]$TRAIL_NAME <- "Alder"
    ...
    dat[dat$TRAIL_NAME == "North Pickett Trail",]$TRAIL_NAME <- "Rabbit Creek Meadow"
    ...
    dat[dat$TRAIL_NAME == "Pickett Spur Trail",]$TRAIL_NAME <- "Rabbit Creek Meadow"    
    ...
    dat[dat$TRAIL_NAME == "East Rib to MchHugh Cr",]$TRAIL_NAME <- "Potter McHugh Ridge"
    ...
    dat[dat$TRAIL_NAME == "McHugh",]$TRAIL_NAME <- "McHugh Lake"
    dat[dat$TRAIL_NAME == "ER Access 1",]$TRAIL_NAME <- "Albert Loop"
    dat[dat$TRAIL_NAME == "ER Access 2",]$TRAIL_NAME <- "Albert Loop"
    dat[dat$TRAIL_NAME == "ER Access 3",]$TRAIL_NAME <- "Albert Loop"
    ...
    dat[dat$TRAIL_NAME == "Yurt Classroom",]$TRAIL_NAME <- "Albert Loop"
    dat[dat$TRAIL_NAME == "Public Use Cabin",]$TRAIL_NAME <- "Crow Pass"
    dat[dat$TRAIL_NAME == "Rapid Camp Yurt",]$TRAIL_NAME <- "Crow Pass"
    dat[dat$TRAIL_NAME == "Four Corners Loop",]$TRAIL_NAME <- "Albert Loop"
    dat[dat$TRAIL_NAME == "Bird Valley",]$TRAIL_NAME <- "Penguin Creek"
    dat[dat$TRAIL_NAME == "Eklutna ATV Access",]$TRAIL_NAME <- "Eklutna Lakeside"
